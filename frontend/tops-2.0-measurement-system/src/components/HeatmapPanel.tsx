...
//   const [scatterData, setScatterData] = useState<Plotly.Data | null>(null);
...
//     // Extract filtered x, y, and z for scatter plot
//     const scatterX = filteredData.map((d) => d.x);
//     const scatterY = filteredData.map((d) => d.y);
//     const scatterZ = filteredData.map((d) => d.z * 1e6); // Scale to µV for color

//     // Set scatter plot data for Plotly
//     const newScatterData: Plotly.Data = {
//       x: scatterX,
//       y: scatterY,
//       mode: "markers",
//       type: "scatter",
//       marker: {
//         size: 10, // Marker size for visibility
//         color: scatterZ, // Scaled z-values for color
//         colorscale: "Greys", // Grayscale colorscale
//         showscale: true, // Show colorbar
//         colorbar: { title: "Voltage (µV)" },
//         reversescale: true, // Darker for higher (less negative) values
//       },
//       text: scatterZ.map((z) => z.toFixed(3)), // Show µV in hover, rounded for readability
//       hovertemplate: "X: %{x}<br>Y: %{y}<br>Voltage: %{text} µV<extra></extra>",
//     };
//     setScatterData(newScatterData);
//     setShowScatter(true);
//     setStatus("Scatter plot generated");
//   };

//   return (
//     <div className="bg-gray-800 p-4 rounded-lg flex flex-col h-full">
//       <h2 className="text-white text-lg font-semibold mb-2">Scatter Plot</h2>
//       <div className="flex space-x-4 mb-4">
//         <input
//           type="file"
//           accept=".csv"
...
//         </button>
//       </div>
//       {showScatter && scatterData && (
//         <Plot
//           data={[scatterData]}
//           layout={{
//             width: 400,
//             height: 400,
//             title: "Voltage Scatter Plot (µV)",
//             xaxis: {
//               title: "Position X",
//               showgrid: true,
//               gridcolor: "white",
