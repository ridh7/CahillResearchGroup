...
% 
% % material
% lambda_down=[150 0.1 1];           % thermal conductivity (W/m-K) in the surface normal direction
% eta_down=[1 1 1];                     % anisotropy of thermal conductivity; eta=kx/ky; kx is in-plane; ky is surface normal direction
% C_down=[2.44 0.1 1.65]*1e6;           % specific heat (J/m^3-K)
...
incident_pump=0.65e-3;     % avarage power of digital power (square wave) pump before lens (W), set 10mW
